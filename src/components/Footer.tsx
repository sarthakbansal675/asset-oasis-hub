      ...
      <div className="container py-12">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="text-sm mb-4">Subscribe to our newsletter for the latest updates on new asset listings and market insights.</p>
            <div className="flex space-x-2">
              ...
              />
              <Button className="bg-marketplace-blue hover:bg-marketplace-blue/90 text-white shrink-0">
                Subscribe
              </Button>
            </div>
          </div>
